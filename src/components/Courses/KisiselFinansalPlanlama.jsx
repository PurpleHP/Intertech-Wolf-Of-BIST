...
function KisiselFinansalPlanlama() {
    ...
    const allParagraphs = [
        "Kişisel finansal planlama, bireylerin finansal hedeflerine ulaşmak için gelirlerini, giderlerini, tasarruflarını ve yatırımlarını düzenli bir şekilde yönetmelerine yardımcı olan bir süreçtir. Etkili bir finansal plan, bireylerin kısa ve uzun vadeli hedeflerini gerçekleştirmelerine, finansal güvenliklerini sağlamalarına ve gelecekteki mali zorluklarla başa çıkmalarına olanak tanır.",
    ];
...
export default KisiselFinansalPlanlama;
