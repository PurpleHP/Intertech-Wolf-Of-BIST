...
function TasarrufveAcilDurumFonlari() {
    //MARK: Paragraf Bölümü
    const { education, Header } = useApiRequest(10);
    
    const summary = { title: "Tasarruf ve Acil Durum Fonları Özet", index: 0 }; // Özetin indexini 0 olarak ayarlıyoruz.
    
    const allParagraphs = [
        "Tasarruf ve acil durum fonları, bireylerin finansal güvenliğini artırmak ve beklenmedik durumlarla başa çıkmak için oluşturdukları mali rezervlerdir. Bu fonlar, kişisel finans yönetiminin önemli bir parçasıdır ve çeşitli finansal hedeflere ulaşmada kritik rol oynar.",
    ];
...
export default TasarrufveAcilDurumFonlari;
