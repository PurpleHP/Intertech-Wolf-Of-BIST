...
function Kredi() {
    ...
    const allParagraphs = [
        "Kredi yönetimi, bireylerin ve işletmelerin kredi kullanımı, ödemeleri ve geri ödemeleri ile ilgili süreçleri düzenli bir şekilde planlama, takip etme ve optimize etme faaliyetidir. Kredi yönetimi, finansal esneklik sağlar, acil durumlarda likiditeyi artırır ve büyük yatırımlar için gerekli fonları sağlar. Etkili kredi yönetimi, mali hedeflere ulaşmada ve finansal sağlığın korunmasında kritik bir rol oynar.",
    ];
