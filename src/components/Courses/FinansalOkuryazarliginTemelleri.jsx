...
function GelirveVergiYonetimi() {
    ...
    const allParagraphs = [
    "Ekonomide iki farklı aktör vardır. dfn className=fonFondfn arz edenler ve fon talep edenler. Fon arz edenler, ellerinde ihtiyaçlarından fazla fon bulunan kişiler iken, fon talep edenler ihtiyaç duydukları kadar fona sahip olmayanlardır. Bu kişiler arasında borç ya da ortaklık ilişkisinin doğması kaçınılmazdır. Gelin borç ilişkisine göz atalım. Borç isteyenlerin, bu borcu verebilecek kişileri bulması pek kolay değildir, bulsa bile şartlarda anlaşamayabilirler. Örneğin, yatırım yapmak isteyen bir kişi yatırımından ancak dfn className=fonfondfn üç yıl sonra gelir elde etmeye başlayabilecek ve ancak üç yıl sonrasında geri ödeme yapabilecektir, ancak fon fazlası olan kişiler en fazla bir yıllığına borç vermek istiyor olabilir.",    
